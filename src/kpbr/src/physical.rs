    ...
    pub fn apply(&self, material: &mut Material) {
        ...
        material.set_param(
            ...
            Vec4::new(
                ...
                self.dispersion.max(0.0),
            ),
        );
        material.set_param(
            1,
            Vec4::new(
                self.iridescence.clamp(0.0, 1.0),
                self.film_thickness.max(0.0),
                self.sheen_roughness.clamp(0.0, 1.0),
                self.alpha_cutoff,
            ),
        );
        ...
        material.set_param(
            3,
            Vec4::new(
                self.anisotropy.clamp(0.0, 1.0) + if has_texture { 2.0 } else { 0.0 },
